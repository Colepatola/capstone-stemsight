...
# Import pipeline
from run_pipeline import LiveDeadPipeline, find_image_sets
...
class PipelineWorker(QThread):
    ...
    def __init__(self, pipeline, input_dir, output_dir, visualize=True):
        super().__init__()
    ...
    def run(self):
        try:
            ...
            self.progress.emit(f"Found {len(image_sets)} image sets")
...
class LiveDeadGUI(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.model_path_edit.setPlaceholderText("Path to live_dead_classifier.pth")
        ...
        threshold_layout.addWidget(QLabel("Fluorescence threshold:"))
    ...
    def load_default_model(self):
        ...
        possible_paths = [
            ...
            script_dir / "live_dead_classifier.pth",
    ...
    def load_model(self, path):
        ...
        try:
            self.pipeline = LiveDeadPipeline(path)
